...
public class RoundEventHandlers
{
    ...
    public RoundEventHandlers(RetakesPlugin plugin, GameManager gameManager, SpawnManager spawnManager, BreakerManager? breakerManager, BarrierManager? barrierManager, AllocationService allocationService, AnnouncementService announcementService, bool isAutoPlantEnabled, bool enableFallbackAllocation, bool enableFallbackBombsiteAnnouncement, bool isBarrierEnabled, float barrierRemoveDelay, Random random, MapConfigService mapConfigService)
    {
        _plugin = plugin;
    ...
    public void SetCommandReferences(ShowSpawnsCommand? showSpawnsCommand, BarrierEditorCommands? barrierEditorCommands)
    {
